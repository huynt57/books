<div id="modal-add" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    ...
    <form action="<?php echo Yii::app()->createUrl('book/AddForWeb')?>" method="POST" class='form-horizontal form-bordered form-validate' id="form-add" enctype="multipart/form-data">
            ...
            <div class="box box-bordered">
                ...
                <div class="box-content nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="book_name" id="book_name" class="input-xlarge" data-rule-required="true">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="book_image" class="control-label">Image</label>
                        <div class="controls">
                           <input type="file" name="book_image" id="book_image" class="input-block-level" data-rule-required="true">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="book_author" id="book_author"  class="input-xlarge" data-rule-required="true">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="book_publisher" class="control-label">Publisher</label>
                        <div class="controls">
                            <input type="text" name="book_publisher" id="book_author"  class="input-xlarge" data-rule-required="true">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="book_year" class="control-label">Year</label>
                        <div class="controls">
                            <input type="text" name="book_year" id="book_author"  class="input-xlarge" data-rule-required="true">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="book_description" id="textarea" rows="4" class="input-block-level" data-rule-required="true"></textarea>
                        </div>
                    </div>
